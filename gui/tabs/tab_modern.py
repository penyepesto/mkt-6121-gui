...
from ..ops.ai_ops import get_operations as get_ai_ops


class ModernTab(QWidget):
    """‘Modern Methods’ sekmesi – Detection, Segmentation, Anomaly, GANs."""
    def __init__(self, input_manager, canvas, parent=None):
        ...
        self.btn_run = QPushButton("Run Modern Ops")
